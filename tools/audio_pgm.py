...
SOURCES = {  # name -> audio flow uuid
    ...
    # remote commentators: browser mic -> WHIP -> webrtc2mxl "Commentary
    # Audio" / "Commentary 2 Audio" (UUIDs deterministic from those labels;
    # commentary.html and commentary.html?slot=2)
